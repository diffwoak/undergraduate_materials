...
'''
python main.py --outf=result --niter=5000 --batchSize=64 --cuda --dataset=CUB_200 --imageSize=128 --dataroot=../../datasets/CUB_200_2011/CUB_200_2011/images --gpu=1
python main.py --outf=result1 --niter=5000 --batchSize=64 --cuda --dataset=CUB_200 --imageSize=64 --dataroot=../../datasets/CUB_200_2011/CUB_200_2011/images --gpu=1
'''
...
if opt.dataset == 'imagenet' or opt.dataset == 'CUB_200':
    netG = _netG(ngpu, nz)
else:
...
for epoch in range(opt.niter):
    for i, data in enumerate(dataloader, 0):
        ...
        print("dis_output shape:", dis_output.shape)
        print("dis_label shape:", dis_label.shape)
