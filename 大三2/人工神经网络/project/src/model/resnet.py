...
#     'ntsnet': 'https://github.com/nicolalandro/ntsnet_cub200/releases/download/0.2/nts_net_cub200.pt',
}
...
def resnet50(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('resnet50',
                   ...
                   layers=[3, 4, 6, 3],
                   **kwargs)
# def ntsnet(pretrained=True, progress=True, **kwargs):
#     """Construct 50 layer Resnet model as in
#     https://arxiv.org/abs/1512.03385
